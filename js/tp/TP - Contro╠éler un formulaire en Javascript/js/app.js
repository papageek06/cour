...
document.getElementById("myForm").addEventListener("submit", function (event) {
    ...
    if(lastNameOK && firstNameOK && loginOK && ageOK && pwd1OK && pwd2OK && sexeOK && country ) {
        alert("Controle ok");
    } else {
...
let erreur = document.getElementsByClassName("tooltip");

    for ( let i= 0 ; i< erreur.length ; i++) {
erreur[i].style.display = "inline-block" ; 
    }
